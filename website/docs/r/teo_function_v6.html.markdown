...
layout: "tencentcloud"
page_title: "TencentCloud: tencentcloud_teo_function_v6"
sidebar_current: "docs-tencentcloud-resource-teo_function_v6"
description: |-
  Provides a resource to manage an EdgeOne (TEO) edge function.
---

# tencentcloud_teo_function_v6
...
* `domain_compliance_restrictions` - Domain compliance restrictions list.
