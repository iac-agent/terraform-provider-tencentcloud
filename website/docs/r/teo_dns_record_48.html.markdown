...
layout: "tencentcloud"
page_title: "TencentCloud: tencentcloud_teo_dns_record_48"
sidebar_current: "docs-tencentcloud-resource-teo_dns_record_48"
description: |-
  Provides a resource to create a TEO (TencentCloud EdgeOne) dns_record
---

# tencentcloud_teo_dns_record_48
...
* `zone_id` - (Required, String, ForceNew) TEO Zone ID.
