...
layout: "tencentcloud"
page_title: "TencentCloud: tencentcloud_teo_dns_record_20"
sidebar_current: "docs-tencentcloud-resource-teo_dns_record_20"
description: |-
  Provides a resource to create a TEO (EdgeOne) DNS record
---

# tencentcloud_teo_dns_record_20
...
```hcl
resource "tencentcloud_teo_dns_record_20" "example" {
...
```
terraform import tencentcloud_teo_dns_record_20.example {zoneId}#{recordId}
```
