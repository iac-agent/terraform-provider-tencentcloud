...
layout: "tencentcloud"
page_title: "TencentCloud: tencentcloud_teo_l7_acc_rules"
sidebar_current: "docs-tencentcloud-resource-teo_l7_acc_rules"
description: |-
  Provides a resource to manage the complete set of TEO L7 acceleration rules under a zone.
---

# tencentcloud_teo_l7_acc_rules
...
* `rules` - (Required, List) The list of L7 acceleration rules. Each rule contains rule_name, status, description, and branches.
* `zone_id` - (Required, String, ForceNew) Zone id.
* `filters` - (Optional, List) Filter conditions for the Describe API. The upper limit of Filters.Values is 20.
...
* `rule_ids` - The rule IDs returned by the Create API.
