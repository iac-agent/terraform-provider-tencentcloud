...
layout: "tencentcloud"
page_title: "TencentCloud: tencentcloud_teo_dns_record_25"
sidebar_current: "docs-tencentcloud-resource-teo_dns_record_25"
description: |-
  Provides a resource to create a TEO dns record
---

# tencentcloud_teo_dns_record_25
...
```hcl
resource "tencentcloud_teo_dns_record_25" "example" {
...
```
terraform import tencentcloud_teo_dns_record_25.example zone-39quuimqg8r6#rec-abcdefghij
```
