...
* `cos_paths` - List of COS file names for the exported image. File name format: system disk - prefix_imageID_system_snapshotID.imageFormat, data disk - prefix_imageID_data_snapshotID.imageFormat.
