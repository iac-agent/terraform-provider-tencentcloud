...
layout: "tencentcloud"
page_title: "TencentCloud: tencentcloud_teo_dns_record_v3"
sidebar_current: "docs-tencentcloud-resource-teo_dns_record_v3"
description: |-
  Provides a resource to create a teo teo_dns_record_v3
---

# tencentcloud_teo_dns_record_v3
...
```hcl
resource "tencentcloud_teo_dns_record_v3" "teo_dns_record_v3" {
...
teo teo_dns_record_v3 can be imported using the id, e.g.

```
terraform import tencentcloud_teo_dns_record_v3.teo_dns_record_v3 {zoneId}#{recordId}
```
