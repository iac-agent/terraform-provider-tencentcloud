# teo-function-v4-resource Specification

## Purpose
Manage the full lifecycle of a TencentCloud TEO (TencentCloud Edge One) Edge Function through the `tencentcloud_teo_function_v4` Terraform resource, mapping to the native TEO APIs `CreateFunction`, `DescribeFunctions`, `ModifyFunction`, and `DeleteFunction` from the `github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/teo/v20220901` package.
