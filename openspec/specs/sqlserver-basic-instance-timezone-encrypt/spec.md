# sqlserver-basic-instance-timezone-encrypt Specification

## Purpose
TBD - created by archiving change add-sqlserver-timezone-diskencrypt. Update Purpose after archive.
## Requirements
