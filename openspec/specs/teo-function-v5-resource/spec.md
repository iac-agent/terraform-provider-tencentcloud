# teo-function-v5-resource Specification

## Purpose

Defines the requirements for the `tencentcloud_teo_function_v5` Terraform resource that manages EdgeOne edge functions.
