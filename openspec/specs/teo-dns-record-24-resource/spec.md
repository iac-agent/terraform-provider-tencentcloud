...
- **THEN** the system logs the id for debugging, then sets resource ID to empty string and logs a warning
...
The system SHALL include unit tests using gomonkey mock approach for the resource's CRUD operations.
