# redis-instance-password-policy Specification

## Purpose
Manages the password complexity policy of an existing TencentCloud Redis instance via the `tencentcloud_redis_instance_password_policy` Terraform resource.
