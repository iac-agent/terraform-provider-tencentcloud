# vpc-end-point-service-white-list Specification

## Purpose
TBD - created by archiving change add-vpc-endpoint-service-white-list-total-count. Update Purpose after archive.
## Requirements
