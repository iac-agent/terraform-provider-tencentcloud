	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"lock_days": {
				...
				ForceNew:    true,
				Type:        schema.TypeInt,
				Description: "数量 max days 到 lock 域名+ Old packages: D_FREE 30 days，D_PLUS 90 days，D_EXTRA 30 days，D_EXPERT 60 days，D_ULTRA 365 days+ New packages: DP_FREE 365 days，DP_PLUS 365 days，DP_EXTRA 365 days，DP_EXPERT 365 days，DP_ULTRA 365 days。",
			},

			"lock_code": {
				Computed:    true,
				Type:        schema.TypeString,
				Description: "域名 unlock 代码，可以 是 获取 through ModifyDomainLock interface。",
			},
		},
	}
}
