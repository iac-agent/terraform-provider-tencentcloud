...
func DataSourceTencentCloudSslDescribeHostWafInstanceList() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudSslDescribeHostWafInstanceListRead,
		Schema: map[string]*schema.Schema{
			...
			"instance_list": {
				Computed:    true,
				Type:        schema.TypeList,
				Description: "WAF instance listNote: This field may return NULL，indicating that the valid 值 cannot be obtained。",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"domain": {
							Type:        schema.TypeString,
						...
						"cert_id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Binded certificate IDNote: This field may return NULL，indicating that the valid 值 cannot be obtained。",
						},
						"status": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "-1: Unrelated certificate of 域名 名称1: The 域名 名称 HTTPS has been opened.0: The 域名 名称 HTTPS has been closed。",
						},
					},
				},
			},
...
func dataSourceTencentCloudSslDescribeHostWafInstanceListRead(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("data_source.tencentcloud_ssl_describe_host_waf_instance_list.read")()
