	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"domain_num": {
				...
				Required:    true,
				ForceNew:    true,
				Description: "数量 域名 names included in the certificate。",
			},
			"time_span": {
				Type:        schema.TypeInt,
				Optional:    true,
				Default:     1,
				Description: "Certificate 周期，currently only supports 1 year certificate purchase。",
			},
			"project_id": {
				Type:        schema.TypeInt,
				Optional:    true,
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"certificate_domain": {
							Type:        schema.TypeString,
							Required:    true,
							Description: "域名 名称 for binding certificate。",
						},
						"organization_name": {
							Type:        schema.TypeString,
							Required:    true,
						...
						"organization_country": {
							Type:        schema.TypeString,
							Required:    true,
							Description: "Country 名称，such as China: CN。",
						},
						"organization_city": {
							Type:        schema.TypeString,
							Required:    true,
						...
						"admin_first_name": {
							Type:        schema.TypeString,
							Required:    true,
							Description: "The first 名称 administrator。",
						},
						"admin_last_name": {
							Type:        schema.TypeString,
							Required:    true,
							Description: "The last 名称 administrator。",
						},
						"admin_phone_num": {
							Type:        schema.TypeString,
							Required:    true,
						...
						"admin_email": {
							Type:        schema.TypeString,
							Required:    true,
							Description: "The administrator's email 地址",
						},
						"admin_position": {
							Type:        schema.TypeString,
							Required:    true,
						...
						"domain_list": {
							...
							Description: "数组 uploaded 域名 names，multi-域名 certificates can be uploaded。",
						},
						"key_password": {
							Type:        schema.TypeString,
							Optional:    true,
			...
			"status": {
				Type:        schema.TypeInt,
				Computed:    true,
				Description: "SSL certificate 状态",
			},
			"dv_auths": {
				Type:        schema.TypeList,
				Computed:    true,
...
func resourceTencentCloudSSLInstanceCreate(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_ssl_pay_certificate.create")()
	...
	d.SetId(strings.Join([]string{certificateId,
		...
		strconv.FormatInt(*request.TimeSpan, 10)}, tccommon.FILED_SP))
...
func resourceTencentCloudSSLInstanceRead(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_ssl_pay_certificate.read")()
...
func resourceTencentCloudSSLInstanceDelete(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_ssl_pay_certificate.delete")()
