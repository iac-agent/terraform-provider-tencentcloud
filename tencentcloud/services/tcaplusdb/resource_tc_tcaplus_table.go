	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"cluster_id": {
				...
				Required:    true,
				ForceNew:    true,
				Description: "ID TcaplusDB cluster to which the table belongs。",
			},
			"tablegroup_id": {
				Type:        schema.TypeString,
				Required:    true,
				ForceNew:    true,
				Description: "ID table group to which the table belongs。",
			},
			"table_name": {
				Type:        schema.TypeString,
				Required:    true,
			...
			"table_type": {
				...
				Description:  "类型 TcaplusDB table. Valid values are `GENERIC` and `LIST`。",
			},
			"description": {
				Type:        schema.TypeString,
				Optional:    true,
			...
			"table_idl_type": {
				...
				Description:  "IDL 类型 TcaplusDB table. 有效值：`PROTO` and `TDR`。",
			},
			"reserved_read_cu": {
				Type:        schema.TypeInt,
				Required:    true,
			...
			"error": {
				Type:        schema.TypeString,
				Computed:    true,
				Description: "错误 messages for creating TcaplusDB table。",
			},
			"status": {
				Type:        schema.TypeString,
				Computed:    true,
