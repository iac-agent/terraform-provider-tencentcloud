	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"tablegroup_id": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "ID table group to be query。",
			},
			"table_id": {
				Type:        schema.TypeString,
				Optional:    true,
			...
			"table_name": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "Table 名称 to be query。",
			},
			"result_output_file": {
				Type:        schema.TypeString,
				Optional:    true,
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"tablegroup_id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Table group ID TcaplusDB table。",
						},
						"table_id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "ID TcaplusDB table。",
						},
						"table_name": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"table_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "类型 TcaplusDB table。",
						},
						"description": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "描述 TcaplusDB table。",
						},
						"idl_id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "IDL file ID TcaplusDB table。",
						},
						"table_idl_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "IDL 类型  the TcaplusDB table。",
						},
						"reserved_read_cu": {
							Type:        schema.TypeInt,
							Computed:    true,
						...
						"create_time": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "创建时间 of the TcaplusDB table。",
						},
						"error": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "错误信息 for creating TcaplusDB table。",
						},
						"status": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "状态 TcaplusDB table。",
						},
						"table_size": {
							Type:        schema.TypeInt,
							Computed:    true,
