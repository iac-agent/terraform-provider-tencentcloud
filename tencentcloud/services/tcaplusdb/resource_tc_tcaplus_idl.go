	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"tablegroup_id": {
				...
				Required:    true,
				ForceNew:    true,
				Description: "ID table group to which the IDL file belongs。",
			},
			"file_name": {
				Type:        schema.TypeString,
				Required:    true,
				ForceNew:    true,
				Description: "名称 IDL file。",
			},
			"file_type": {
				Type:         schema.TypeString,
				Required:     true,
				...
				Description:  "类型 IDL file. Valid values are PROTO and TDR。",
			},
			"file_ext_type": {
				Type:         schema.TypeString,
				Required:     true,
				...
				Description:  "File ext 类型 IDL file. If `file_type` is `PROTO`，`file_ext_type` must be 'proto'; If `file_type` is `TDR`，`file_ext_type` must be 'xml'。",
			},
			"file_content": {
				Type:        schema.TypeString,
				Required:    true,
				ForceNew:    true,
				Description: "IDL file 内容 of the TcaplusDB table。",
			},
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"error": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "错误 messages for creating IDL file。",
						},
						"table_name": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "名称 TcaplusDB table。",
						},
						"key_fields": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Primary 键 fields of the TcaplusDB table。",
						},
						"sum_key_field_size": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "Total size of primary 键 field of the TcaplusDB table。",
						},
						"value_fields": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Non-primary 键 fields of the TcaplusDB table。",
						},
						"sum_value_field_size": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "Total size of non-primary 键 fields of the TcaplusDB table。",
						},
						"index_key_set": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "索引 键 set of the TcaplusDB table。",
						},
					},
				},
			},
