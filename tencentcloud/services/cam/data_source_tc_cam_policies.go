	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"create_mode": {
				Type:        schema.TypeInt,
				Optional:    true,
				Description: "模式 of creation of policy strategy. 有效值：`1`，`2`. `1` means policy was created with console，and `2` means it was created by strategies。",
			},
			"scope": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "Available values are 'All'，'QCS'，and' Local '.' All 'retrieves all policies,' QCS' retrieves preset policies，'Local' retrieves custom policies，and 默认为 'All'。",
			},
			"key_word": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "Match by strategy 名称",
			},
			"result_output_file": {
				Type:        schema.TypeString,
				Optional:    true,
			...
			"policy_list": {
				...
				Computed:    true,
				Description: "A 列表 CAM policies. Each element 包含following attributes:",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"attachments": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "数量 attached users。",
						},
						"service_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "名称 attached products。",
						},
						"create_time": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"type": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "类型 policy strategy. `1` means customer strategy and `2` means preset strategy。",
						},
						"create_mode": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "模式 of creation of policy strategy. `1` means policy was created with console，and `2` means it was created by strategies。",
						},
						"policy_id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "ID policy strategy。",
						},
					},
				},
			},
