	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"policies": {
				Computed:    true,
				Type:        schema.TypeInt,
				Description: "The 数量 policy。",
			},

			"roles": {
				Computed:    true,
				Type:        schema.TypeInt,
				Description: "The 数量 角色",
			},

			"user": {
				Computed:    true,
				Type:        schema.TypeInt,
				Description: "The 数量 Sub-用户",
			},

			"group": {
				Computed:    true,
				Type:        schema.TypeInt,
				Description: "The 数量 Group。",
			},

			"member": {
				Computed:    true,
				Type:        schema.TypeInt,
				Description: "The 数量 grouped users。",
			},

			"identity_providers": {
				Computed:    true,
				Type:        schema.TypeInt,
				Description: "The 数量 identity provider。",
			},
