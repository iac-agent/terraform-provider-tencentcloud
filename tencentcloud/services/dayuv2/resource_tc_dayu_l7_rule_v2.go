				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"cert_type": {
							...
							Optional:    true,
							Default:     0,
							Description: "The 来源 of the certificate must be filled in when the forwarding 协议 is https，the 值 [2 (Tencent Cloud Hosting Certificate)]，and 0 when the forwarding 协议 is http。",
						},
						"ssl_id": {
							Type:        schema.TypeString,
							Optional:    true,
							Description: "When the certificate 来源 is a Tencent Cloud managed certificate，this field must be filled in with the managed 证书 ID",
						},
						"source_list": {
							Type:     schema.TypeList,
							Required: true,
						...
						"cc_enable": {
							...
							Optional:    true,
							Default:     0,
							Description: "HTTPS 协议 CC protection 状态，值 [0 (off)，1 (on)]，defaule is 0。",
						},
						"https_to_http_enable": {
							Type:        schema.TypeInt,
							Optional:    true,
							Default:     0,
							Description: "是否enable the Https 协议 to use Http back-to-来源，take the 值 [0 (off)，1 (on)]，do not fill in the 默认为 off，defaule is 0。",
						},
					},
				},
			},
