	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"bind_resource_region": {
				...
				Required:    true,
				ForceNew:    true,
				Description: "Resource 地域 to bind。",
			},
			"bind_resource_type": {
				Type:         schema.TypeString,
				Required:     true,
				...
				Description:  "资源类型 to bind，值 range [`clb`，`cvm`]。",
			},
			"resource_region": {
				Type:        schema.TypeString,
				Computed:    true,
				Description: "地域 of the resource instance。",
			},
			"eip_bound_rsc_ins": {
				Type:        schema.TypeString,
				Computed:    true,
			...
			"eip_address_status": {
				Type:        schema.TypeString,
				Computed:    true,
				Description: "Eip 地址 状态 resource instance。",
			},
			"protection_status": {
				Type:        schema.TypeString,
				Computed:    true,
				Description: "Protection 状态 resource instance。",
			},
			"created_time": {
				Type:        schema.TypeString,
				Computed:    true,
			...
			"expired_time": {
				Type:        schema.TypeString,
				Computed:    true,
				Description: "过期时间 of the resource instance。",
			},
			"modify_time": {
				Type:        schema.TypeString,
				Computed:    true,
				Description: "修改时间 of the resource instance。",
			},
		},
	}
}
