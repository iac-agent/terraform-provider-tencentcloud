	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"definition": {
				...
				Optional:    true,
				Description: "Unique ID 过滤器 的 镜像 sprite template。",
			},
			"type": {
				Type:        schema.TypeString,
				Optional:    true,
			...
			"template_list": {
				...
				Computed:    true,
				Description: "A 列表 镜像 sprite templates. Each element 包含following attributes:",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"definition": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Unique ID 镜像 sprite template。",
						},
						"type": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"resolution_adaptive": {
							...
							Computed:    true,
							Description: "Resolution adaption. 有效值：`true`: 已启用 In 此 case，`宽度` 表示 long side 的 视频，while `高度` short side; `false`: 已禁用 In 此 case，`宽度` 表示 宽度 的 视频，while `高度` 高度。",
						},
						"create_time": {
							Type:        schema.TypeString,
							Computed:    true,
