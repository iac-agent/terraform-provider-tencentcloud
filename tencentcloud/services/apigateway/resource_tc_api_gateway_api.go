	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"service_id": {
				...
				Required:    true,
				ForceNew:    true,
				Description: "The unique ID service where the API is located. Refer to resource `tencentcloud_api_gateway_service`。",
			},
			"api_name": {
				Type:        schema.TypeString,
				Required:    true,
			...
			"target_services": {
				Optional:    true,
				Type:        schema.TypeList,
				Description: "Target 类型 backend resource information. (Internal testing stage)。",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"vm_ip": {
							Type:        schema.TypeString,
			...
			"target_services_load_balance_conf": {
				Optional:    true,
				Type:        schema.TypeInt,
				Description: "Target 类型 load balancing configuration. (Internal testing stage)。",
			},
			...
			"eiam_app_type": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "EIAM application 类型",
			},
			"eiam_auth_type": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "The EIAM application authentication 类型 supports AuthenticationOnly，Authentication，and Authorization。",
			},
			"eiam_app_id": {
				Optional:    true,
				Type:        schema.TypeString,
			...
			"token_timeout": {
				Optional:    true,
				Type:        schema.TypeInt,
				Description: "The effective time of the EIAM application 令牌，measured （秒）， 默认为 7200 seconds。",
			},
			"owner": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "所有者 of resources。",
			},
			"release_limit": {
				Type:        schema.TypeInt,
				Optional:    true,
