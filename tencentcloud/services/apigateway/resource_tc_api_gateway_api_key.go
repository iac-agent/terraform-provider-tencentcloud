	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"access_key_type": {
				...
				Type:         schema.TypeString,
				Description:  "键 类型，supports both auto and manual (custom keys)，默认为 auto。",
			},
			"access_key_id": {
				Optional:     true,
				Computed:     true,
				...
				Description:  "用户 defined 键 ID，必填 when access_key_type is manual. The length is 5-50 characters，consisting of letters，numbers，and English underscores。",
			},
			"access_key_secret": {
				Type:         schema.TypeString,
				Optional:     true,
				...
				Description:  "The 用户-defined 键 must be passed when the access_key_type is manual. The length is 10-50 characters，consisting of letters，numbers，and English underscores。",
			},
			// Computed values.
			"modify_time": {
				Type:        schema.TypeString,
