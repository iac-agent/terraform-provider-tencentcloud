	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"instance_ids": {
				...
				Description: "过滤器 通过 实例 ID。",
			},
			"search_word": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "过滤器 通过 实例名称，support fuzzy 查询。",
			},
			"tag_key": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "Matches 标签键 值",
			},
			"status": {
				Type:        schema.TypeList,
				Optional:    true,
				Elem:        &schema.Schema{Type: schema.TypeInt},
				Description: "(过滤器 Criteria) 状态 实例. 0: Create，1: Run，2: Delete，do 不 fill 默认值 返回 all。",
			},
			"filters": {
				Type:     schema.TypeList,
				Optional: true,
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"name": {
							Type:        schema.TypeString,
							Required:    true,
							Description: "字段 该 needs 到 是 filtered。",
						},
						"values": {
							Type: schema.TypeList,
							Elem: &schema.Schema{
							...
							Required:    true,
							Description: "filtered 值 的 字段。",
						},
					},
				},
				Description: "过滤器. 过滤器.名称 支持 ('Ip'，'VpcId'，'SubNetId'，'InstanceType','实例 ID')，过滤器.值 可以 pass up 到 10 值。",
			},
			"offset": {
				Type:        schema.TypeInt,
				Optional:    true,
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"status": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "状态 实例. 0: Created，1: Running，2: Delete: 5 Quarantined，-1 Creation failed。",
						},
						"bandwidth": {
							Type:        schema.TypeInt,
							Computed:    true,
						...
						"vpc_id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "VpcId，如果为空，表示that 它 是 underlying 网络。",
						},
						"subnet_id": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"renew_flag": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "是否instance 是 renewed， int enumeration 值: 1 表示auto-renewal，和 2 表示that 它 是 不 automatically renewed。",
						},
						"healthy": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "实例状态 int: 1 表示health，2 表示alarm，和 3 表示abnormal 实例状态",
						},
						"healthy_message": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"is_internal": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "是否为an 内部 customer. A 值 的 1 表示an 内部 customer。",
						},
						"topic_num": {
							Type:        schema.TypeInt,
							Computed:    true,
						...
						"version": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Kafka 版本 信息. 注意: 此 字段 可能 返回 null，indicating 该 有效 值 could 不 是 retrieved。",
						},
						"zone_ids": {
							Type:        schema.TypeList,
							Computed:    true,
							Elem:        &schema.Schema{Type: schema.TypeInt},
							Description: "Across Availability Zones. 注意: 此 字段 可能 返回 null，indicating 该 有效 值 could 不 是 retrieved。",
						},
						"cvm": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "ckafka sale 类型 注意: 此 字段 可能 返回 null，indicating 该 有效 值 could 不 是 retrieved。",
						},
						"instance_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "ckafka 实例类型 注意: 此 字段 可能 返回 null，indicating 该 有效 值 could 不 是 retrieved。",
						},
						"disk_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Disk 类型 注意: 此 字段 可能 返回 null，indicating 该 有效 值 could 不 是 retrieved。",
						},
						"max_topic_number": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "最大topics 在 当前 specifications. 注意: 此 字段 可能 返回 null，indicating 该 有效 值 could 不 是 retrieved.。",
						},
						"max_partition_number": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "最大Partitions 对于 当前 specifications. 注意: 此 字段 可能 返回 null，indicating 该 有效 值 could 不 是 retrieved。",
						},
						"rebalance_time": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Schedule upgrade 配置 时间. 注意: 此 字段 可能 返回 null，indicating 该 有效 值 could 不 是 retrieved.。",
						},
						"partition_number": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "当前 数量 实例. 注意: 此 字段 可能 返回 null，indicating 该 有效 值 could 不 是 retrieved.。",
						},
						"public_network_charge_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "类型 Internet 带宽. 注意: 此 字段 可能 返回 null，indicating 该 有效 值 could 不 是 retrieved.。",
						},
						"public_network": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "Internet 带宽 值 注意: 此 字段 可能 返回 null，indicating 该 有效 值 could 不 是 retrieved.。",
						},
					},
				},
			},
