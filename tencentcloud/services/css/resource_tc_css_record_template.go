	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"template_name": {
				...
				Description: "模板名称 Only `Chinese`，`English`，`numbers`，`_`，`-` are supported。",
			},
			...
			"flv_param": {
				...
				MaxItems:    1,
				Description: "Flv recording parameters are set when Flv recording is 已启用",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"record_interval": {
							Type:        schema.TypeInt,
							Optional:    true,
							Description: "Recording interval.  单位：second，默认值：1800.  取值范围：30-7200.  This parameter is invalid for HLS. When recording HLS，a file is generated from streaming to streaming。",
						},
						"storage_time": {
							Type:        schema.TypeInt,
							Optional:    true,
							Description: "Recording storage duration.  单位：second. 取值范围：0 - 1500 days.  0: 表示permanent storage。",
						},
						"enable": {
							Type:        schema.TypeInt,
							Optional:    true,
							Description: "是否enable recording in the current 格式 The 默认值为 0. 0: No，1: Yes。",
						},
						"vod_sub_app_id": {
							Type:        schema.TypeInt,
							Optional:    true,
							Description: " The ID vodSub app。",
						},
						"vod_file_name": {
							Type:        schema.TypeString,
							Optional:    true,
							Description: "Record file 名称Special placeholders supported are: `StreamID`: Stream ID,`StartYear`: 开始时间 - year,`StartMonth`: 开始时间 - month,`StartDay`: 开始时间 - day,`StartHour`: 开始时间 - hour,`StartMinute`: 开始时间 - minutes,`StartSecond`: 开始时间 - seconds,`StartMillisecond`: 开始时间 - milliseconds,`EndYear`: 结束时间 - year,`EndMonth`: 结束时间 - month,`EndDay`: 结束时间 - day,`EndHour`: 结束时间 - hour,`EndMinute`: 结束时间 - minutes,`EndSecond`: 结束时间 - seconds,`EndMillisecond`: 结束时间 - millisecondsIf the default recording file 名称 is not set as ,`StreamID`_ ,`StartYear`-,`StartMonth`-,`StartDay`-,`StartHour`-,`StartMinute`-,`StartSecond`_ ,`EndYear`-,`EndMonth`-,`EndDay`-,`EndHour`-,`EndMinute`-,`EndSecond`。",
						},
						"procedure": {
							Type:        schema.TypeString,
							Optional:    true,
							Description: "Task flow. This field may return null，indicating that no valid 值 can be obtained。",
						},
						"storage_mode": {
							Type:        schema.TypeString,
							Optional:    true,
							Description: "Video storage strategy. Normal: standard storage. Cold: low frequency storage. This field may return null，indicating that no valid 值 can be obtained。",
						},
						"class_id": {
							Type:        schema.TypeInt,
							Optional:    true,
							Description: "Classification of on-demand applications. 注意：此字段可能返回 null，表示无法获取有效值。",
						},
					},
				},
			},
			...
			"hls_param": {
				...
				Type:        schema.TypeList,
				MaxItems:    1,
				Description: "Hls recording parameters，which are set when hls recording is 已启用",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"record_interval": {
							Type:        schema.TypeInt,
						...
						"vod_file_name": {
							Type:        schema.TypeString,
							Optional:    true,
							Description: "Record file 名称Special placeholders supported are: `StreamID`: Stream ID,`StartYear`: 开始时间 - year,`StartMonth`: 开始时间 - month,`StartDay`: 开始时间 - day,`StartHour`: 开始时间 - hour,`StartMinute`: 开始时间 - minutes,`StartSecond`: 开始时间 - seconds,`StartMillisecond`: 开始时间 - milliseconds,`EndYear`: 结束时间 - year,`EndMonth`: 结束时间 - month,`EndDay`: 结束时间 - day,`EndHour`: 结束时间 - hour,`EndMinute`: 结束时间 - minutes,`EndSecond`: 结束时间 - seconds,`EndMillisecond`: 结束时间 - millisecondsIf the default recording file 名称 is not set as ,`StreamID`,`StartYear`,`StartMonth`,`StartDay`,`StartHour`,`StartMinute`,`StartSecond`,`EndYear`,`EndMonth`,`EndDay`,`EndHour`,`EndMinute`,`EndSecond`。",
						},
						"procedure": {
							Type:        schema.TypeString,
							Optional:    true,
							Description: "Task flow. 注意：此字段可能返回 null，表示无法获取有效值。",
						},
						"storage_mode": {
							Type:        schema.TypeString,
							Optional:    true,
							Description: "Video storage strategy. Normal: standard storage. Cold: low frequency storage. 注意：此字段可能返回 null，表示无法获取有效值。",
						},
						"class_id": {
							Type:        schema.TypeInt,
							Optional:    true,
			...
			"mp4_param": {
				...
				Type:        schema.TypeList,
				MaxItems:    1,
				Description: "Mp4 recording parameters are set when Mp4 recording is 已启用",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"record_interval": {
							Type:        schema.TypeInt,
						...
						"vod_sub_app_id": {
							Type:        schema.TypeInt,
							Optional:    true,
							Description: "The ID on-demand sub app。",
						},
						"vod_file_name": {
							Type:        schema.TypeString,
							Optional:    true,
			...
			"aac_param": {
				...
				Type:        schema.TypeList,
				MaxItems:    1,
				Description: "Aac recording parameters are set when Aac recording is 已启用",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"record_interval": {
							Type:        schema.TypeInt,
						...
						"class_id": {
							Type:        schema.TypeInt,
							Optional:    true,
							Description: "Classification of on-demand applications. This field may return null，indicating that no valid 值 can be obtained。",
						},
					},
				},
			},
			...
			"is_delay_live": {
				Optional:    true,
				Type:        schema.TypeInt,
				Description: "Live broadcast 类型，0 by default. 0: Ordinary live broadcast，1: Slow broadcast。",
			},
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"flow_continue_duration": {
							Type:        schema.TypeInt,
							Optional:    true,
							Description: "HLS freewheeling timeout. 值 range [0，1800]。",
						},
					},
				},
			},
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"class_id": {
							Type:        schema.TypeInt,
							Optional:    true,
							Description: "Classification of vod applications. 注意：此字段可能返回 null，表示无法获取有效值。",
						},
					},
				},
			},
			...
			"remove_watermark": {
				...
				Description: "是否remove the watermark. This parameter is invalid when the 类型 is slow live broadcast。",
			},
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"upload_in_recording": {
							Type:        schema.TypeBool,
							Optional:    true,
							Description: "是否enable the transfer while recording is valid only in the flv 格式",
						},
					},
				},
			},
