...
func DataSourceTencentCloudDcdbProjectSecurityGroups() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudDcdbProjectSecurityGroupsRead,
		Schema: map[string]*schema.Schema{
			"product": {
				Required:    true,
				Type:        schema.TypeString,
				Description: "Database 引擎 名称 有效 值: `dcdb`。",
			},
			...
			"groups": {
				...
				Description: "Security 组 details。",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"create_time": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "创建时间 在 格式 的 yyyy-mm-dd hh:mm:ss。",
						},
						"security_group_id": {
							Type:        schema.TypeString,
							Computed:    true,
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"cidr_ip": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "来源 IP 或 来源 IP 范围，such 作为 192.168.0.0/16。",
									},
									"action": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Policy，其中 可以 是 `ACCEPT` 或 `DROP`。",
									},
									"port_range": {
										Type:        schema.TypeString,
										Computed:    true,
									...
									"ip_protocol": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Network 协议 UDP 和 TCP 是 支持。",
									},
								},
							},
						},
...
func dataSourceTencentCloudDcdbProjectSecurityGroupsRead(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("data_source.tencentcloud_dcdb_project_security_groups.read")()
	...
	err := resource.Retry(tccommon.ReadRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeDcdbProjectSecurityGroupsByFilter(ctx, paramMap)
		if e != nil {
