	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"domains": {
				...
				Computed:    true,
				Description: "An information 列表 forward 域名 of the layer7 listeners. Each element 包含following attributes:",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"certificate_id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "ID server certificate。",
						},
						...
						"realserver_auth": {
							...
							Computed:    true,
							Description: "表示是否realserver authentication is enable。",
						},
						...
						"realserver_certificate_domain": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "CA certificate 域名 of the realserver。",
						},
						"basic_auth": {
							Type:        schema.TypeBool,
							Computed:    true,
							Description: "表示是否basic authentication is enable。",
						},
						"basic_auth_id": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"gaap_auth": {
							Type:        schema.TypeBool,
							Computed:    true,
							Description: "表示是否SSL certificate authentication is enable。",
						},
						"gaap_auth_id": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"is_default_server": {
							Type:        schema.TypeBool,
							Computed:    true,
							Description: "是否use as the default 域名 名称",
						},
					},
				},
			},
