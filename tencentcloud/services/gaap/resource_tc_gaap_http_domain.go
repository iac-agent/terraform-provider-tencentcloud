	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"is_default_server": {
				...
				Optional:    true,
				Default:     false,
				Description: "是否use as the default 域名 名称，the 默认为 false。",
			},
			"domain": {
				Type:        schema.TypeString,
				Required:    true,
				ForceNew:    true,
				Description: "Forward 域名 of the layer7 listener。",
			},
			"certificate_id": {
				Type:        schema.TypeString,
				Optional:    true,
				Default:     "default",
				Description: "ID server certificate，默认值为 `default`。",
			},
			"client_certificate_id": {
				...
				Description:   "ID client certificate，默认值为 `default`。",
			},
			"client_certificate_ids": {
				...
				Description:   "ID 列表 the poly client certificate。",
			},
			"basic_auth": {
				Type:        schema.TypeBool,
				Optional:    true,
				Default:     false,
				Description: "表示是否basic authentication is enable，默认值为 `false`。",
			},
			"basic_auth_id": {
				Type:        schema.TypeString,
				Optional:    true,
			...
			"realserver_auth": {
				...
				Optional:    true,
				Default:     false,
				Description: "表示是否realserver authentication is enable，默认值为 `false`。",
			},
			...
			"realserver_certificate_ids": {
				...
				Description:   "CA 证书 ID 列表 the realserver。",
			},
			"realserver_certificate_domain": {
				Type:        schema.TypeString,
				Optional:    true,
				Computed:    true,
				Description: "CA certificate 域名 of the realserver. It has been 已弃用",
			},
			"gaap_auth": {
				Type:        schema.TypeBool,
				Optional:    true,
				Default:     false,
				Description: "表示是否SSL certificate authentication is enable，默认值为 `false`。",
			},
			"gaap_auth_id": {
				Type:        schema.TypeString,
				Optional:    true,
...
func resourceTencentCloudGaapHttpDomainCreate(d *schema.ResourceData, m interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_gaap_http_domain.create")()
	gaapActionMu.Lock()
...
func resourceTencentCloudGaapHttpDomainRead(d *schema.ResourceData, m interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_gaap_http_domain.read")()
...
func resourceTencentCloudGaapHttpDomainUpdate(d *schema.ResourceData, m interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_gaap_http_domain.update")()
	gaapActionMu.Lock()
	defer gaapActionMu.Unlock()
...
func resourceTencentCloudGaapHttpDomainDelete(d *schema.ResourceData, m interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_gaap_http_domain.delete")()
	gaapActionMu.Lock()
	defer gaapActionMu.Unlock()
