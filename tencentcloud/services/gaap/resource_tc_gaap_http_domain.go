	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"is_default_server": {
				...
				Optional:    true,
				Default:     false,
				Description: "是否use 作为 默认值 域名 名称， 默认为 false。",
			},
			"domain": {
				Type:        schema.TypeString,
				Required:    true,
			...
			"certificate_id": {
				...
				Optional:    true,
				Default:     "default",
				Description: "ID 服务器 证书，默认值为 `默认值`。",
			},
			"client_certificate_id": {
				...
				Description:   "ID 客户端 证书，默认值为 `默认值`。",
			},
			"client_certificate_ids": {
				...
				Description:   "ID 列表 poly 客户端 证书。",
			},
			"basic_auth": {
				Type:        schema.TypeBool,
				Optional:    true,
				Default:     false,
				Description: "表示是否basic authentication 是 启用，默认值为 `false`。",
			},
			"basic_auth_id": {
				Type:        schema.TypeString,
				Optional:    true,
			...
			"realserver_auth": {
				...
				Optional:    true,
				Default:     false,
				Description: "表示是否realserver authentication 是 启用，默认值为 `false`。",
			},
			...
			"realserver_certificate_domain": {
				...
				Optional:    true,
				Computed:    true,
				Description: "CA 证书 域名 的 realserver. It has been 已弃用",
			},
			"gaap_auth": {
				Type:        schema.TypeBool,
				Optional:    true,
				Default:     false,
				Description: "表示是否SSL 证书 authentication 是 启用，默认值为 `false`。",
			},
			"gaap_auth_id": {
				Type:        schema.TypeString,
				Optional:    true,
