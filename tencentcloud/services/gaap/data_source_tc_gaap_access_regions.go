	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"access_region_set": {
				...
				Description: "Acceleration 可用区 Details List。",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"region_name": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "English or Chinese 名称 地域",
						},
						"region_area": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"region_area_name": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "名称 地域 to which the computer room belongs。",
						},
						"idc_type": {
							Type:        schema.TypeString,
							Computed:    true,
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"network_type": {
										...
										Computed:    true,
										Description: "A 列表 network types supported by the access area，with normal indicating support for regular BGP，cn2 indicating premium BGP，triple indicating three networks，and secure_ EIP represents a custom secure EIP。",
									},
								},
							},
						},
