				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"region_name": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "English 或 Chinese 名称 地域",
						},
						"region_area": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"region_area_name": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "名称 地域 到 其中 computer room belongs。",
						},
						"idc_type": {
							Type:        schema.TypeString,
							Computed:    true,
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"network_type": {
										...
										Computed:    true,
										Description: "A 列表 网络 types 支持 通过 访问 area，使用 normal indicating support 对于 regular BGP，cn2 indicating premium BGP，triple indicating three networks，和 secure_ EIP 表示 自定义 secure EIP。",
									},
								},
							},
						},
