	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"tags": {
				Type:        schema.TypeMap,
				Optional:    true,
				Description: "标签 of the cluster。",
			},

			"kube_config_file_prefix": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "The 路径 prefix of kube 配置 You can store KubeConfig in a specified directory by specifying this field，such as ~/.kube/k8s，then public network access will use ~/.kube/k8s-clusterID-kubeconfig naming，and intranet access will use ~/.kube /k8s-clusterID-kubeconfig-intranet naming. If this field is not set，the KubeConfig will not be exported。",
			},

			"list": {
				Type:        schema.TypeList,
				Computed:    true,
				Description: "An information 列表 kubernetes clusters. Each element 包含following attributes:",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"cluster_deploy_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Deployment 类型 cluster。",
						},
						"cluster_version": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "版本 of the cluster。",
						},
						"cluster_ipvs": {
							Type:        schema.TypeBool,
							Computed:    true,
							Description: "表示是否ipvs is 已启用",
						},
						"vpc_id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Vpc ID cluster。",
						},
						"project_id": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "项目 ID cluster。",
						},
						"cluster_cidr": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "A network 地址 block of the cluster. Different from vpc cidr and cidr of other clusters within this VPC。",
						},
						"ignore_cluster_cidr_conflict": {
							Type:        schema.TypeBool,
							Computed:    true,
							Description: "表示是否ignore the cluster cidr conflict 错误",
						},
						"cluster_max_pod_num": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "The 最大Pods per node in the cluster。",
						},
						"cluster_max_service_num": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "The 最大services in the cluster。",
						},
						"cluster_as_enabled": {
							Type:        schema.TypeBool,
							Computed:    true,
							Description: "表示是否enable cluster node auto scaler。",
						},
						"node_name_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "节点名称 类型 cluster。",
						},
						"cluster_extra_args": {
							Type:        schema.TypeList,
							Computed:    true,
						...
						"network_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Cluster network 类型",
						},
						"is_non_static_ip_mode": {
							Type:        schema.TypeBool,
							Computed:    true,
							Description: "表示是否non-static ip 模式 is 已启用",
						},
						"kube_proxy_mode": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"vpc_cni_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Distinguish between shared network card multi-IP 模式 and independent network card 模式",
						},
						"service_cidr": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "The network 地址 block of the cluster。",
						},
						"eni_subnet_ids": {
							Type:        schema.TypeList,
							Computed:    true,
							Description: "Subnet IDs for cluster with VPC-CNI network 模式",
							Elem: &schema.Schema{
								Type: schema.TypeString,
							},
						},
						...
						"deletion_protection": {
							Type:        schema.TypeBool,
							Computed:    true,
							Description: "表示是否cluster 删除保护 is 已启用",
						},
						"cluster_node_num": {
							Type:        schema.TypeInt,
							Computed:    true,
