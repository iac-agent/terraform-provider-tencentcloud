	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"file_system_id": {
				...
				Optional:    true,
				Description: "A specified file system ID 用于query。",
			},
			"name": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "A file system 名称 用于query。",
			},
			"availability_zone": {
				Type:        schema.TypeString,
				Optional:    true,
			...
			"file_system_list": {
				...
				Computed:    true,
				Description: "An information 列表 cloud file system. Each element 包含following attributes:",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"file_system_id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "ID file system。",
						},
						"name": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "名称 file system。",
						},
						"availability_zone": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"protocol": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "协议 of the file system。",
						},
						"access_group_id": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"storage_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Storage 类型 file system。",
						},
						"status": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "状态 file system。",
						},
						"create_time": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"size_limit": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "Size 限制 of the file system。",
						},
						"size_used": {
							Type:        schema.TypeInt,
							Computed:    true,
