	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"client_token": {
				...
				Optional:    true,
				Description: "A string 用于ensure the idempotence of the request. This string is generated by the customer and must be unique across different requests，with a 最大长度64 ASCII characters. If this parameter is not specified，the idempotence of the request cannot be guaranteed. Example 值: system-f3827db9-c58a-49cc-bf10-33fc1923a34a。",
			},
			"placement": {
				Type:        schema.TypeList,
				Optional:    true,
				MaxItems:    1,
				Description: "The position of the instance. This parameter allows you to 指定attributes such as the availability 可用区，project，and 主机 machine (when creating a sub-instance on CDH) that the instance belongs to. Note: If you do not 指定LaunchTemplate parameter，Placement is a mandatory parameter. If both Placement and LaunchTemplate are passed，the values in Placement override the corresponding values in LaunchTemplate by default。",
			...
			"space_charge_prepaid": {
				...
				Optional:    true,
				MaxItems:    1,
				Description: "Prepaid 模式: This refers to the parameters related to the annual and monthly subscription. By this parameter，you can 指定purchase duration of the prepaid instances，是否set auto-renewal，and other attributes. If the instance's billing 模式 is prepaid，this parameter 为必填项。",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"period": {
							Type:        schema.TypeInt,
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"disk_size": {
							...
							Optional:    true,
							Computed:    true,
							Description: "Size of the system disk. unit is GB，默认为 50GB。",
						},
					},
				},
			},
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"password": {
							...
							Optional:    true,
							Sensitive:   true,
							Description: "密码 for the instance. In 顺序 for the new 密码 to take effect，the instance will be restarted after the 密码 change. Modifying will cause the instance reset。",
						},
						"key_ids": {
							Type:        schema.TypeSet,
							Optional:    true,
							Description: "The 键 pair to use for the instance，it looks like `skey-16jig7tx`. Modifying will cause the instance reset。",
							Elem:        &schema.Schema{Type: schema.TypeString},
						},
					},
				},
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"security_service": {
							...
							Optional:    true,
							MaxItems:    1,
							Description: "Activate cloud security services. If this parameter is not specified，cloud security services will be 已启用 by default。",
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"enabled": {
										Type:        schema.TypeBool,
						...
						"monitor_service": {
							...
							Optional:    true,
							MaxItems:    1,
							Description: "Activate Tencent Cloud Observable Platform service. If this parameter is not specified，the Tencent Cloud Observable Platform service will be 已启用 by default。",
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"enabled": {
										Type:        schema.TypeBool,
						...
						"automation_service": {
							...
							Optional:    true,
							MaxItems:    1,
							Description: "Enable the TencentCloud Automation Tools (TAT) service. If this parameter is not specified，the cloud automation tools service will be 已启用 by default。",
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"enabled": {
										Type:        schema.TypeBool,
			...
			"user_data": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "用户 Data for Workspace。",
			},
