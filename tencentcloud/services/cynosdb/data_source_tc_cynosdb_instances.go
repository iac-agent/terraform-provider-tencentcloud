				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"instance_name": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "CynosDB 实例的名称。",
						},
						"instance_cpu_core": {
							Type:        schema.TypeInt,
							Required:    true,
							Description: "Cynosdb实例的CPU核数。",
						},
						"instance_memory_size": {
							Type:        schema.TypeInt,
							Required:    true,
							Description: "Cynosdb实例的内存容量，单位为GB。",
						},
						"instance_storage_size": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "Cynosdb实例的存储大小，单位为GB。",
						},
						"instance_status": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Cynosdb 实例的状态。",
						},
						"create_time": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "CynosDB 实例的创建时间。",
						},
						"instance_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "实例类型。 `ro` 表示只读实例，`rw` 表示读写实例。",
						},
					},
				},
			},
