	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"resource_dashboard_set": {
				...
				Description: "列表 resource objects。",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"vpc_id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "VPC 实例 ID，such as `vpc-bq4bzxpj`。",
						},
						"subnet_id": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"ip": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "Total 数量 used IPs except for CVM IP，EIP and network probe IP. The three IP types will be independently counted。",
						},
						"nat": {
							Type:        schema.TypeInt,
							Computed:    true,
