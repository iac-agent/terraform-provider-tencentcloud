	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"subnet_id": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "ID subnet to be queried。",
			},
			"name": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "名称 subnet to be queried。",
			},
			"availability_zone": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "可用区 of the subnet to be queried。",
			},
			"is_default": {
			...
			"tag_key": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "Filter if subnet has this 标签",
			},
			"cidr_block": {
				Type:        schema.TypeString,
				Optional:    true,
			...
			"is_remote_vpc_snat": {
				Type:        schema.TypeBool,
				Optional:    true,
				Description: "Filter the VPC SNAT 地址 pool subnet。",
			},
			"tags": {
				Type:        schema.TypeMap,
				Optional:    true,
				Description: "标签 of the subnet to be queried。",
			},
			"result_output_file": {
				Type:        schema.TypeString,
				Optional:    true,
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"availability_zone": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "The availability 可用区 of the subnet。",
						},
						"vpc_id": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"name": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "名称 subnet。",
						},
						"cidr_block": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "A network 地址 block of the subnet。",
						},
						"cdc_id": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"is_default": {
							Type:        schema.TypeBool,
							Computed:    true,
							Description: "表示是否it is the default subnet of the VPC for this 地域",
						},
						"is_multicast": {
							Type:        schema.TypeBool,
							Computed:    true,
							Description: "表示是否multicast is 已启用",
						},
						"route_table_id": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"available_ip_count": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "The 数量 available IPs。",
						},
						"create_time": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "创建时间 of the subnet resource。",
						},
						"tags": {
							Type:        schema.TypeMap,
							Computed:    true,
							Description: "标签 of the subnet resource。",
						},
					},
				},
			},
