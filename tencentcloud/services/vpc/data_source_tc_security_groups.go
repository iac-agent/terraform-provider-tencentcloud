	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"security_group_id": {
				...
				Description:   "ID security group to be queried. Conflict with `名称` and `project_id`。",
			},
			"name": {
				Type:          schema.TypeString,
				Optional:      true,
				...
				Description:   "名称 security group to be queried. Conflict with `security_group_id`。",
			},
			"project_id": {
				Type:          schema.TypeInt,
				Optional:      true,
				ConflictsWith: []string{"security_group_id"},
				Description:   "项目 ID security group to be queried. Conflict with `security_group_id`。",
			},
			"tags": {
				Type:          schema.TypeMap,
				Optional:      true,
				ConflictsWith: []string{"security_group_id"},
				Description:   "标签 of the security group to be queried. Conflict with `security_group_id`。",
			},
			"result_output_file": {
				Type:        schema.TypeString,
				Optional:    true,
			...
			"security_groups": {
				...
				Computed:    true,
				Description: "Information 列表 security group。",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"name": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "名称 security group。",
						},
						"description": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "描述 security group。",
						},
						"create_time": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "创建时间 of security group。",
						},
						"be_associate_count": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "数量 security group binding resources。",
						},
						"project_id": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "项目 ID security group。",
						},
						"ingress": {
							Type:        schema.TypeList,
							Computed:    true,
							Elem:        &schema.Schema{Type: schema.TypeString},
							Description: "Ingress rules set. For items like `[操作]#[cidr_ip]#[端口]#[协议]`，it means a regular rule; for items like `sg-XXXX`，it means a nested security group。",
						},
						"egress": {
							Type:        schema.TypeList,
							Computed:    true,
							Elem:        &schema.Schema{Type: schema.TypeString},
							Description: "Egress rules set. For items like `[操作]#[cidr_ip]#[端口]#[协议]`，it means a regular rule; for items like `sg-XXXX`，it means a nested security group。",
						},
						"tags": {
							Type:        schema.TypeMap,
							Computed:    true,
							Description: "标签 of the security group。",
						},
					},
				},
			},
