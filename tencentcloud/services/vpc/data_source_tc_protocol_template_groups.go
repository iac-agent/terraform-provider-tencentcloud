	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"name": {
				...
				Optional:    true,
				Description: "名称 协议 template group to query。",
			},
			"id": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "ID 协议 template group to query。",
			},
			"result_output_file": {
				Type:        schema.TypeString,
				Optional:    true,
			...
			"group_list": {
				...
				Computed:    true,
				Description: "Information 列表 the dedicated 协议 template groups。",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Id of the 协议 template group。",
						},
						"name": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"template_ids": {
							...
							Computed:    true,
							Description: "ID set of the 协议 template。",
						},
					},
				},
			},
...
func dataSourceTencentCloudProtocolTemplateGroupsRead(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("data_source.tencentcloud_protocol_template_groups.read")()
