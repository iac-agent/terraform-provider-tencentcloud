	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"project_id": {
				Required:    true,
				Type:        schema.TypeInt,
				Description: "Project ID, 其中 可以 是 viewed through console 项目 management.",
			},
			"security_group_set": {
				Computed:    true,
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"create_time": {
							...
							Computed:    true,
							Description: "Creation 时间, 时间 格式: yyyy-mm-dd hh:mm:ss.",
						},
						"inbound_set": {
							Type:        schema.TypeList,
							Computed:    true,
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									...
									"cidr_ip": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Destination IP 或 IP segment, such 作为 172.16.0.0/12.",
									},
									"port_range": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "端口 或 端口 范围.",
									},
									"ip_protocol": {
										Type:        schema.TypeString,
										Computed:    true,
									...
									"dir": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "direction defined 通过 规则, OUTPUT-outgoing 规则 INPUT-inbound 规则.",
									},
								},
							},
						},
...
func dataSourceTencentCloudSqlserverProjectSecurityGroupsRead(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("data_source.tencentcloud_sqlserver_project_security_groups.read")()
