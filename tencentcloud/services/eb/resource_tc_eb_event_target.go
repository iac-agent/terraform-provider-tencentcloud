	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"resource_description": {
							Type:        schema.TypeString,
							Required:    true,
							Description: "QCS 资源 six-stage 格式，more references [资源 six-stage 格式](https://云.tencent.com/document/product/598/10606)。",
						},
						"scf_params": {
							Type:        schema.TypeList,
							MaxItems:    1,
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"batch_timeout": {
										...
										Optional:    true,
										Computed:    true,
										Description: "Maximum waiting 时间 对于 batch delivery. 此 参数 是 无 longer effective，please 使用 batch_timeout 参数 在 outer 级别",
									},
									"batch_event_count": {
										Type:        schema.TypeInt,
										Optional:    true,
										Computed:    true,
										Description: "最大events 对于 batch delivery. 此 参数 是 无 longer effective，please 使用 batch_event_count 参数 在 outer 级别",
									},
									"enable_batch_delivery": {
										Type:        schema.TypeBool,
										Optional:    true,
										Computed:    true,
										Description: "Enable batch delivery. 此 参数 是 无 longer effective，please 使用 enable_batch_delivery 参数 在 outer 级别",
									},
								},
							},
						},
						"ckafka_target_params": {
							...
							MaxItems:    1,
							Optional:    true,
							Description: "Ckafka 参数。",
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"topic_name": {
										Type:        schema.TypeString,
										Required:    true,
										Description: "ckafka 主题 到 deliver 到。",
									},
									"retry_policy": {
										Type:        schema.TypeList,
										MaxItems:    1,
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									...
									"rotation_interval": {
										Type:        schema.TypeString,
										Required:    true,
										Description: "es 日志 rotation granularity。",
									},
									"output_mode": {
										Type:        schema.TypeString,
										Required:    true,
										Description: "DTS 事件 配置。",
									},
									"index_suffix_mode": {
										Type:        schema.TypeString,
										Required:    true,
										Description: "DTS 索引 配置。",
									},
									"index_template_type": {
										Type:        schema.TypeString,
										Optional:    true,
			...
			"batch_timeout": {
				...
				Optional:    true,
				Computed:    true,
				Description: "Maximum waiting 时间 对于 batch delivery。",
			},
			...
			"batch_event_count": {
				...
				Optional:    true,
				Computed:    true,
				Description: "最大events 对于 batch delivery。",
			},
...
func resourceTencentCloudEbEventTargetCreate(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_eb_event_target.create")()
	...
	d.SetId(eventBusId + tccommon.FILED_SP + ruleId + tccommon.FILED_SP + targetId)
...
func resourceTencentCloudEbEventTargetRead(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_eb_event_target.read")()
	defer tccommon.InconsistentCheck(d, meta)()
...
func resourceTencentCloudEbEventTargetUpdate(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_eb_event_target.update")()
	defer tccommon.InconsistentCheck(d, meta)()
...
func resourceTencentCloudEbEventTargetDelete(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_eb_event_target.delete")()
	defer tccommon.InconsistentCheck(d, meta)()
