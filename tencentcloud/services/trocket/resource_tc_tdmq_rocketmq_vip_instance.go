	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"spec": {
				Required:    true,
				Type:        schema.TypeString,
				Description: "Instance specification: Universal 类型，rocket-VIP-basic-0，Basic 类型: `rocket-VIP-basic-1`，Standard 类型: `rocket-VIP-basic-2`，Advanced 类型 I: `rocket-VIP-basic-3`，Advanced 类型 II: `rocket-VIP-basic-4`。",
			},
			"node_count": {
				Required:     true,
				Type:         schema.TypeInt,
				ValidateFunc: tccommon.ValidateIntegerInRange(2, 20),
				Description:  "节点数量，minimum 2，maximum 20。",
			},
			"storage_size": {
				Required:     true,
				Type:         schema.TypeInt,
				ValidateFunc: tccommon.ValidateIntegerMin(200),
				Description:  "Single node storage space，（GB）， minimum 200GB。",
			},
			"zone_ids": {
				Required:    true,
				Type:        schema.TypeSet,
				Elem:        &schema.Schema{Type: schema.TypeString},
				Description: "The 可用区 ID list for node deployment，such as Guangzhou 可用区 1，is 100001. For details，please refer to the official website of Tencent Cloud。",
			},
			"vpc_info": {
				Required:    true,
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"ip_rule": {
							Type:        schema.TypeString,
							Required:    true,
							Description: "IP 地址 block information。",
						},
						"allow": {
							Type:        schema.TypeBool,
							Required:    true,
							Description: "是否allow or deny。",
						},
						"remark": {
							Type:        schema.TypeString,
							Required:    true,
