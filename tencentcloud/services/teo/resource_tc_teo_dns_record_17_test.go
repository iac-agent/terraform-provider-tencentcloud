...
// go test ./tencentcloud/services/teo/ -run "TestDnsRecord17" -v -count=1 -gcflags="all=-l"

// TestDnsRecord17_Create_Success tests Create calls API and sets composite ID
func TestDnsRecord17_Create_Success(t *testing.T) {
	...
	meta := newMockMeta()
	res := teo.ResourceTencentCloudTeoDnsRecord17()
...
// TestDnsRecord17_Create_APIError tests Create handles API error
func TestDnsRecord17_Create_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestDnsRecord17_Read_Success tests Read retrieves DNS record data
func TestDnsRecord17_Read_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestDnsRecord17_Read_NotFound tests Read handles DNS record not found
func TestDnsRecord17_Read_NotFound(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestDnsRecord17_Update_ContentFields tests Update modifies DNS record content fields
func TestDnsRecord17_Update_ContentFields(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
			...
			DnsRecords: []*teov20220901.DnsRecord{
				{
					...
					Status:     ptrString("enable"),
					CreatedOn:  ptrString("2024-01-01T00:00:00Z"),
					ModifiedOn: ptrString("2024-01-03T00:00:00Z"),
				},
			},
			RequestId: ptrString("fake-request-id"),
		}
...
// TestDnsRecord17_Update_Status tests Update modifies DNS record status
func TestDnsRecord17_Update_Status(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestDnsRecord17_Delete_Success tests Delete removes DNS record
func TestDnsRecord17_Delete_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestDnsRecord17_Delete_APIError tests Delete handles API error
func TestDnsRecord17_Delete_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestDnsRecord17_Schema validates schema definition
func TestDnsRecord17_Schema(t *testing.T) {
	res := teo.ResourceTencentCloudTeoDnsRecord17()
