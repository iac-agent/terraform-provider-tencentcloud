	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"l7_hosts": {
				...
				Description: "列表 L7 acceleration domains 该 require enabling 源站 ACLs. 此 列表 必须 是 空 当 请求 参数 L7EnableMode 是 集合 到 'all'。",
			},
			...
			"l4_proxy_ids": {
				...
				Computed:    true,
				Elem:        &schema.Schema{Type: schema.TypeString},
				Description: "he 列表 L4 proxy Instances 该 require enabling 源站 ACLs. 此 列表 必须 是 空 当 请求 参数 L4EnableMode 是 集合 到 'all'。",
			},
		},
	}
}
