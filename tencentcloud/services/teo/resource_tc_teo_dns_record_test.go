...
// go test ./tencentcloud/services/teo/ -run "TestTeoDnsRecord" -v -count=1 -gcflags="all=-l"

// TestTeoDnsRecord_Create_Success tests Create calls API and sets composite ID
func TestTeoDnsRecord_Create_Success(t *testing.T) {
	...
	meta := newMockMeta()
	res := teo.ResourceTencentCloudTeoDnsRecord()
...
// TestTeoDnsRecord_Create_APIError tests Create handles API error
func TestTeoDnsRecord_Create_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord_Create_NilResponse tests Create handles nil response
func TestTeoDnsRecord_Create_NilResponse(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord_Read_Success tests Read retrieves DNS record data
func TestTeoDnsRecord_Read_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord_Read_NotFound tests Read handles record not found
func TestTeoDnsRecord_Read_NotFound(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord_Update_Content_Success tests Update calls ModifyDnsRecords API
func TestTeoDnsRecord_Update_Content_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord_Update_Status_Success tests Update calls ModifyDnsRecordsStatus API
func TestTeoDnsRecord_Update_Status_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord_Update_APIError tests Update handles API error
func TestTeoDnsRecord_Update_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord_Delete_Success tests Delete removes DNS record
func TestTeoDnsRecord_Delete_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord_Delete_APIError tests Delete handles API error
func TestTeoDnsRecord_Delete_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord_Schema validates schema definition
func TestTeoDnsRecord_Schema(t *testing.T) {
	res := teo.ResourceTencentCloudTeoDnsRecord()
