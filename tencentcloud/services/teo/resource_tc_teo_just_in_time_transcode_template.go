				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"video_codec": {
							Type:        schema.TypeString,
							Optional:    true,
							Description: "Video codec. 可选值：H.264，H.265。",
						},
						"fps": {
						...
						"resolution_adaptive": {
							Type:        schema.TypeString,
							Optional:    true,
							Description: "Resolution adaptive 模式 可选值：open，close. 默认值：open。",
						},
						"width": {
							Type:         schema.TypeInt,
							Optional:     true,
						...
						"fill_type": {
							Type:        schema.TypeString,
							Optional:    true,
							Description: "Fill 类型 可选值：stretch，black，white，gauss. 默认值：black。",
						},
					},
				},
			},
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"codec": {
							Type:        schema.TypeString,
							Optional:    true,
							Description: "Audio codec. 可选值：libfdk_aac。",
						},
						"audio_channel": {
							Type:         schema.TypeInt,
							Optional:     true,
							Default:      2,
							Description:  "Audio channel count. 可选值：2. 默认值：2。",
