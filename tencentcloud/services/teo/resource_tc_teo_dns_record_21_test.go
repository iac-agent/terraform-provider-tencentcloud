...
// go test ./tencentcloud/services/teo/ -run "TestTeoDnsRecord21" -v -count=1 -gcflags="all=-l"

// TestTeoDnsRecord21_Create_Success tests Create calls API and sets composite ID
func TestTeoDnsRecord21_Create_Success(t *testing.T) {
	...
	meta := newMockMeta()
	res := teo.ResourceTencentCloudTeoDnsRecord21()
...
// TestTeoDnsRecord21_Create_APIError tests Create handles API error
func TestTeoDnsRecord21_Create_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord21_Read_Success tests Read retrieves DNS record data
func TestTeoDnsRecord21_Read_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord21_Read_NotFound tests Read handles record not found
func TestTeoDnsRecord21_Read_NotFound(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord21_Update_Success tests Update calls ModifyDnsRecords API
func TestTeoDnsRecord21_Update_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord21_Update_APIError tests Update handles API error
func TestTeoDnsRecord21_Update_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord21_Delete_Success tests Delete removes DNS record
func TestTeoDnsRecord21_Delete_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord21_Delete_APIError tests Delete handles API error
func TestTeoDnsRecord21_Delete_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord21_Schema validates schema definition
func TestTeoDnsRecord21_Schema(t *testing.T) {
	res := teo.ResourceTencentCloudTeoDnsRecord21()
