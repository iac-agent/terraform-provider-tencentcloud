...
// go test ./tencentcloud/services/teo/ -run "TestTeoDnsRecord24" -v -count=1 -gcflags="all=-l"

// TestTeoDnsRecord24_Create_Success tests Create calls API and sets composite ID
func TestTeoDnsRecord24_Create_Success(t *testing.T) {
	...
	patches.ApplyMethodFunc(teoClient, "DescribeDnsRecordsWithContext", func(ctx interface{}, request *teov20220901.DescribeDnsRecordsRequest) (*teov20220901.DescribeDnsRecordsResponse, error) {
...
// TestTeoDnsRecord24_Create_APIError tests Create handles API error
func TestTeoDnsRecord24_Create_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord24_Create_EmptyRecordId tests Create handles empty RecordId in response
func TestTeoDnsRecord24_Create_EmptyRecordId(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord24_Read_Success tests Read retrieves DNS record data
func TestTeoDnsRecord24_Read_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord24_Read_NotFound tests Read handles record not found
func TestTeoDnsRecord24_Read_NotFound(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord24_Update_Success tests Update calls ModifyDnsRecords API
func TestTeoDnsRecord24_Update_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord24_Update_APIError tests Update handles API error
func TestTeoDnsRecord24_Update_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord24_Delete_Success tests Delete removes DNS record
func TestTeoDnsRecord24_Delete_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord24_Delete_APIError tests Delete handles API error
func TestTeoDnsRecord24_Delete_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord24_Schema validates schema definition
func TestTeoDnsRecord24_Schema(t *testing.T) {
	res := teo.ResourceTencentCloudTeoDnsRecord24()
