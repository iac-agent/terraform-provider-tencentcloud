...
func (me *TeoService) DescribeTeoFunctionV3ById(ctx context.Context, zoneId string, functionId string) (ret *teo.Function, errRet error) {
	logId := tccommon.GetLogId(ctx)
	...
	err := resource.Retry(tccommon.ReadRetryTimeout, func() *resource.RetryError {
		result, e := me.client.UseTeoV20220901Client().DescribeFunctionsWithContext(ctx, request)
		if e != nil {
			return tccommon.RetryError(e)
		}
		response = result
