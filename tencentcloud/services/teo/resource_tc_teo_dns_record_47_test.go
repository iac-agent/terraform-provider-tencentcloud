...
// go test ./tencentcloud/services/teo/ -run "TestTeoDnsRecord47" -v -count=1 -gcflags="all=-l"

// TestTeoDnsRecord47_Create_Success tests Create calls API and sets composite ID
func TestTeoDnsRecord47_Create_Success(t *testing.T) {
	...
	meta := newMockMeta()
	res := teo.ResourceTencentCloudTeoDnsRecord47()
...
// TestTeoDnsRecord47_Create_APIError tests Create handles API error
func TestTeoDnsRecord47_Create_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord47_Read_Success tests Read retrieves DNS record data
func TestTeoDnsRecord47_Read_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord47_Read_NotFound tests Read handles record not found
func TestTeoDnsRecord47_Read_NotFound(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord47_Update_Success tests Update calls ModifyDnsRecords API
func TestTeoDnsRecord47_Update_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord47_Update_APIError tests Update handles API error
func TestTeoDnsRecord47_Update_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord47_Delete_Success tests Delete removes DNS record
func TestTeoDnsRecord47_Delete_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord47_Delete_APIError tests Delete handles API error
func TestTeoDnsRecord47_Delete_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord47_Schema validates schema definition
func TestTeoDnsRecord47_Schema(t *testing.T) {
	res := teo.ResourceTencentCloudTeoDnsRecord47()
	...
	// Check dns_records nested block
