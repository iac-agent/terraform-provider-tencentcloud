...
// go test ./tencentcloud/services/teo/ -run "TestTeoDnsRecord23" -v -count=1 -gcflags="all=-l"

// TestTeoDnsRecord23_Create_Success tests Create calls API and sets composite ID
func TestTeoDnsRecord23_Create_Success(t *testing.T) {
	...
	meta := newMockMeta()
	res := teo.ResourceTencentCloudTeoDnsRecord23()
...
// TestTeoDnsRecord23_Create_APIError tests Create handles API error
func TestTeoDnsRecord23_Create_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord23_Read_Success tests Read retrieves DNS record data
func TestTeoDnsRecord23_Read_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord23_Read_NotFound tests Read handles record not found
func TestTeoDnsRecord23_Read_NotFound(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord23_Update_Success tests Update calls ModifyDnsRecords API
func TestTeoDnsRecord23_Update_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord23_Update_APIError tests Update handles API error
func TestTeoDnsRecord23_Update_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord23_Delete_Success tests Delete removes DNS record
func TestTeoDnsRecord23_Delete_Success(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord23_Delete_APIError tests Delete handles API error
func TestTeoDnsRecord23_Delete_APIError(t *testing.T) {
	patches := gomonkey.NewPatches()
	defer patches.Reset()
...
// TestTeoDnsRecord23_Schema validates schema definition
func TestTeoDnsRecord23_Schema(t *testing.T) {
	res := teo.ResourceTencentCloudTeoDnsRecord23()
