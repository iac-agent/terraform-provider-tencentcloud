				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"cos_private_access": {
							...
							Optional:    true,
							Computed:    true,
							Description: "Whether to access the COS origin bucket privately. Available values: `on` (private access), `off` (public access). Note: This field may return null, indicating that no valid value can be obtained.",
						},
					},
				},
			},
