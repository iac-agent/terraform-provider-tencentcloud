	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"resource_type": {
				...
				Description:  "类型 resource that the DDoS policy case works for，valid values are `bgpip`，`bgp`，`bgp-multip` and `net`。",
			},
			"scene_id": {
				Type:        schema.TypeString,
				Required:    true,
				Description: "ID DDoS policy case to be query。",
			},
			"result_output_file": {
				Type:        schema.TypeString,
				Optional:    true,
			...
			"list": {
				...
				Computed:    true,
				Description: "A 列表 DDoS policy cases. Each element 包含following attributes:",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"resource_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "类型 resource that the DDoS policy case works for。",
						},
						"name": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "名称 DDoS policy case。",
						},
						"platform_types": {
							Type: schema.TypeList,
							Elem: &schema.Schema{
						...
						"app_protocols": {
							...
							Elem: &schema.Schema{
								Type:        schema.TypeString,
								Description: "App 协议 of the DDoS policy case。",
							},
							Computed:    true,
						...
						"app_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "App 类型 DDoS policy case。",
						},
						"tcp_start_port": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Start 端口 of the TCP service。",
						},
						"tcp_end_port": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "End 端口 of the TCP service。",
						},
						"udp_start_port": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Start 端口 of the UDP service。",
						},
						"udp_end_port": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "End 端口 of the UDP service。",
						},
						"has_abroad": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Indicate 是否service involves overseas or not。",
						},
						"has_initiate_tcp": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Indicate 是否service actively initiates TCP requests or not。",
						},
						"has_initiate_udp": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Indicate 是否actively initiate UDP requests or not。",
						},
						"has_vpn": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Indicate 是否service involves VPN service or not。",
						},
						"peer_tcp_port": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "The 端口 that actively initiates TCP requests。",
						},
						"peer_udp_port": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "The 端口 that actively initiates UDP requests。",
						},
						"tcp_footprint": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "The fixed 签名 of TCP 协议 load。",
						},
						"udp_footprint": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"min_tcp_package_len": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "The 最小长度TCP 消息 package。",
						},
						"max_tcp_package_len": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "The max length of TCP 消息 package。",
						},
						"min_udp_package_len": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "The 最小长度UDP 消息 package。",
						},
						"max_udp_package_len": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "The max length of UDP 消息 package。",
						},
						"create_time": {
							Type:        schema.TypeString,
							Computed:    true,
