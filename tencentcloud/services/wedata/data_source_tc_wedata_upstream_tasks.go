...
func DataSourceTencentCloudWedataUpstreamTasks() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudWedataUpstreamTasksRead,
...
func dataSourceTencentCloudWedataUpstreamTasksRead(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("data_source.tencentcloud_wedata_upstream_tasks.read")()
	...
	err := resource.Retry(tccommon.ReadRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeWedataUpstreamTasksByFilter(ctx, paramMap)
		if e != nil {
