...
func DataSourceTencentCloudWedataUpstreamTriggerTasks() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudWedataUpstreamTriggerTasksRead,
...
func dataSourceTencentCloudWedataUpstreamTriggerTasksRead(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("data_source.tencentcloud_wedata_upstream_trigger_tasks.read")()
	...
	reqErr := resource.Retry(tccommon.ReadRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeWedataUpstreamTriggerTasksByFilter(ctx, paramMap)
		if e != nil {
