				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"crontab_expression": {
							...
							Optional:    true,
							Computed:    true,
							Description: "Cron expression，默认为 0 0 0 * * `?` *。",
						},
						"start_time": {
							Type:        schema.TypeString,
							Optional:    true,
						...
						"end_time": {
							...
							Optional:    true,
							Computed:    true,
							Description: "End date，默认为 2099-12-31 23:59:59。",
						},
						...
						"schedule_run_type": {
							...
							Optional:    true,
							Computed:    true,
							Description: "Scheduling 类型: 0 Normal scheduling 1 Empty run scheduling，默认为 0。",
						},
						"calendar_open": {
							Type:        schema.TypeString,
							Optional:    true,
						...
						"max_retry_attempts": {
							...
							Optional:    true,
							Computed:    true,
							Description: "Retry strategy - 最大attempts，默认值：4。",
						},
						"execution_ttl": {
							Type:        schema.TypeString,
							Optional:    true,
