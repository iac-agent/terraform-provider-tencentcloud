	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"image_id": {
				...
				Optional:    true,
				Description: "ID image to be queried。",
			},
			"image_type": {
				Type:        schema.TypeList,
				Optional:    true,
				Elem:        &schema.Schema{Type: schema.TypeString},
				Description: "A 列表 the image 类型 to be queried. 有效值：'PUBLIC_IMAGE'，'PRIVATE_IMAGE'，'SHARED_IMAGE'，'MARKET_IMAGE'。",
			},
			"image_name_regex": {
				Type:          schema.TypeString,
				Optional:      true,
			...
			"instance_type": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "实例类型，such as `S1.SMALL1`。",
			},
			"result_output_file": {
				Type:        schema.TypeString,
				Optional:    true,
			...
			"images": {
				Type:        schema.TypeList,
				Computed:    true,
				Description: "An information 列表 image. Each element 包含following attributes:",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"os_name": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "OS 名称 image。",
						},
						"image_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "类型 image。",
						},
						"created_time": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"image_name": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "名称 image。",
						},
						"image_description": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "描述 image。",
						},
						"image_size": {
							Type:        schema.TypeInt,
							Computed:    true,
						...
						"image_creator": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Image 创建者 of the image。",
						},
						"image_source": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Image 来源 of the image。",
						},
						"sync_percent": {
							Type:        schema.TypeInt,
							Computed:    true,
						...
						"snapshots": {
							Type:        schema.TypeList,
							Computed:    true,
							Description: "列表 snapshot details。",
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"snapshot_id": {
										Type:        schema.TypeString,
									...
									"snapshot_name": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Snapshot 名称，the 用户-defined snapshot alias。",
									},
									"disk_usage": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "类型 cloud disk 用于create the snapshot。",
									},
									"disk_size": {
										Type:        schema.TypeInt,
										Computed:    true,
