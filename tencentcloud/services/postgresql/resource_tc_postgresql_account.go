	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"user_name": {
				...
				ForceNew:    true,
				Type:        schema.TypeString,
				Description: "实例 用户名，其中 可以 contain 1-16 letters，digits，和 underscore (_); 可以&amp;amp;#39;t 是 postgres; 可以&amp;amp;#39;t start 使用 numbers，pg_，和 tencentdb_。",
			},
			"password": {
				Required:    true,
				Type:        schema.TypeString,
				Sensitive:   true,
				Description: "密码，其中 可以 contain 8-32 letters，digits，和 symbols (()`~!@#$%^&amp;amp;amp;*-+=_|{}[]:;&amp;amp;#39;&amp;amp;lt;&amp;amp;gt;,.?/); 可以&amp;amp;#39;t start 使用 slash /。",
			},
			"type": {
				Required:     true,
				ForceNew:     true,
				...
				Description:  "类型 用户 有效值：1. normal: regular 用户; 2. tencentDBSuper: 用户 使用 pg_tencentdb_superuser 角色",
			},
			"remark": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "备注 correspond 到 用户 `UserName`，其中 可以 contain 0-60 letters，digits，symbols (-_)，和 Chinese 字符。",
			},
			"lock_status": {
				Optional:    true,
				Computed:    true,
