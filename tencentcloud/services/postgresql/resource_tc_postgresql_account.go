	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"user_name": {
				...
				ForceNew:    true,
				Type:        schema.TypeString,
				Description: "Instance 用户名，which can contain 1-16 letters，digits，and underscore (_); can&amp;amp;#39;t be postgres; can&amp;amp;#39;t start with numbers，pg_，and tencentdb_。",
			},
			"password": {
				Required:    true,
				Type:        schema.TypeString,
				Sensitive:   true,
				Description: "密码，which can contain 8-32 letters，digits，and symbols (()`~!@#$%^&amp;amp;amp;*-+=_|{}[]:;&amp;amp;#39;&amp;amp;lt;&amp;amp;gt;,.?/); can&amp;amp;#39;t start with slash /。",
			},
			"type": {
				Required:     true,
				ForceNew:     true,
				...
				Description:  "类型 用户 有效值：1. normal: regular 用户; 2. tencentDBSuper: 用户 with the pg_tencentdb_superuser 角色",
			},
			"remark": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "备注 correspond to 用户 `UserName`，which can contain 0-60 letters，digits，symbols (-_)，and Chinese characters。",
			},
			"lock_status": {
				Optional:    true,
				Computed:    true,
				Type:        schema.TypeBool,
				Description: "whether lock 账号 true: locked; false: unlock。",
			},
		},
	}
}
