	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"source_id": {
				...
				Required:    true,
				ForceNew:    true,
				Description: "serial ID 作业 到 是 copied。",
			},
			"source_name": {
				Type:        schema.TypeString,
				Optional:    true,
				ForceNew:    true,
				Description: "名称 作业 到 是 copied。",
			},
			"target_cluster_id": {
				Type:        schema.TypeString,
				Required:    true,
				ForceNew:    true,
				Description: "集群 serial ID 目标 集群。",
			},
			"target_name": {
				Type:        schema.TypeString,
				Optional:    true,
				ForceNew:    true,
				Description: "名称 new 作业。",
			},
			"target_folder_id": {
				Type:        schema.TypeString,
				Optional:    true,
				ForceNew:    true,
				Description: "directory ID new 作业。",
			},
			"job_type": {
				Type:        schema.TypeInt,
				Optional:    true,
				ForceNew:    true,
				Description: "类型 来源 作业。",
			},
			"work_space_id": {
				Optional:    true,
				ForceNew:    true,
