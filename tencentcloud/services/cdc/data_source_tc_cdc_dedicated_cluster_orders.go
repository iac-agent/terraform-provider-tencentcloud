				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"dedicated_cluster_type_id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Dedicated Cluster 类型 ID。",
						},
						"supported_storage_type": {
							Type:        schema.TypeSet,
							Elem:        &schema.Schema{Type: schema.TypeString},
							Computed:    true,
							Description: "Dedicated Cluster Storage 类型",
						},
						...
						"weight": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "Dedicated Cluster Supported 权重",
						},
						"power_draw": {
						...
						"order_status": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Dedicated Cluster 顺序 状态",
						},
						"create_time": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Dedicated Cluster 顺序 创建时间。",
						},
						"dedicated_cluster_order_id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Dedicated Cluster 顺序 ID。",
						},
						"action": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Dedicated Cluster 顺序 操作 类型",
						},
						"dedicated_cluster_order_items": {
							Type:        schema.TypeList,
							Computed:    true,
							Description: "Dedicated Cluster 顺序 Item List。",
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"dedicated_cluster_type_id": {
										Type:        schema.TypeString,
									...
									"name": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Dedicated Cluster 类型 名称",
									},
									"description": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Dedicated Cluster 类型 描述",
									},
									"total_cpu": {
										Type:        schema.TypeInt,
										Computed:    true,
									...
									"compute_format": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Dedicated Cluster Compute 格式",
									},
									"type_family": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Dedicated Cluster 类型 Family。",
									},
									"sub_order_pay_status": {
										Type:        schema.TypeInt,
										Computed:    true,
										Description: "Dedicated Cluster SubOrder Pay 状态",
									},
								},
							},
						},
						...
						"pay_status": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "Dedicated Cluster 顺序 Pay 状态",
						},
						"pay_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Dedicated Cluster 顺序 Pay 类型",
						},
						"time_unit": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Dedicated Cluster 顺序 Pay Time Unit。",
						},
						"time_span": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "Dedicated Cluster 顺序 Pay Time Span。",
						},
						"order_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Dedicated Cluster 顺序 类型",
						},
					},
				},
			},
