	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"goods_category": {
				...
				ValidateFunc: tccommon.ValidateAllowedStringValue(WAF_CATEGORY_CLB),
				Description:  "Billing 顺序 参数. support: premium_clb，enterprise_clb，ultimate_clb。",
			},
			"time_span": {
				Optional:     true,
				Type:         schema.TypeInt,
			...
			"time_unit": {
				...
				Default:      "m",
				Description:  "Time 单位，support d，m，y. d: day，m: month，y: year。",
			},
			"instance_name": {
				Optional:    true,
				Computed:    true,
				Type:        schema.TypeString,
				Description: "Waf 实例名称",
			},
			"auto_renew_flag": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "Auto 续费标识，1: 启用，0: disable。",
			},
			"elastic_mode": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "Is elastic billing 已启用，1: 启用，0: disable。",
			},
			"qps_limit": {
				Optional:     true,
				Computed:     true,
				...
				Description:  "QPS 限制，Minimum setting 10000. Only `elastic_mode` 是 1，可以 是 集合。",
			},
			"bot_management": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "是否purchase Bot management，1: yes，0: 无. 默认为 0。",
			},
			"api_security": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "是否purchase API Security，1: yes，0: 无. 默认为 0。",
			},
			//"domain_pkg_count": {
			//	Optional:     true,
			//	Type:         schema.TypeInt,
			...
			"edition": {
				Computed:    true,
				Type:        schema.TypeString,
				Description: "waf 实例 edition，clb 或 saas。",
			},
			"begin_time": {
				Computed:    true,
				Type:        schema.TypeString,
				Description: "waf 实例 开始时间。",
			},
			"valid_time": {
				Computed:    true,
				Type:        schema.TypeString,
				Description: "waf 实例 有效 时间。",
			},
			"status": {
				Computed:    true,
				Type:        schema.TypeInt,
				Description: "waf 实例状态",
			},
		},
	}
}
...
func resourceTencentCloudWafClbInstanceCreate(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_waf_clb_instance.create")()
...
func resourceTencentCloudWafClbInstanceRead(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_waf_clb_instance.read")()
	defer tccommon.InconsistentCheck(d, meta)()
...
func resourceTencentCloudWafClbInstanceUpdate(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_waf_clb_instance.update")()
	defer tccommon.InconsistentCheck(d, meta)()
...
func resourceTencentCloudWafClbInstanceDelete(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_waf_clb_instance.delete")()
	defer tccommon.InconsistentCheck(d, meta)()
