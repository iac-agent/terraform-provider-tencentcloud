	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"goods_category": {
				...
				Description:  "Billing 顺序 parameters. support: premium_clb，enterprise_clb，ultimate_clb。",
			},
			"time_span": {
				Optional:     true,
				Type:         schema.TypeInt,
			...
			"auto_renew_flag": {
				...
				Description:  "Auto 续费标识，1: enable，0: disable。",
			},
			"elastic_mode": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "Is elastic billing 已启用，1: enable，0: disable。",
			},
			"qps_limit": {
				Optional:     true,
				Computed:     true,
				...
				Description:  "QPS 限制，Minimum setting 10000. Only `elastic_mode` is 1，can be set。",
			},
			"bot_management": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "是否purchase Bot management，1: yes，0: no. 默认为 0。",
			},
			"api_security": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "是否purchase API Security，1: yes，0: no. 默认为 0。",
			},
			//"domain_pkg_count": {
			//	Optional:     true,
			//	Type:         schema.TypeInt,
