	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"access_control": {
				...
				Type:         schema.TypeInt,
				ValidateFunc: tccommon.ValidateAllowedIntValue([]int{0, 1}),
				Description:  "ACL 模块 状态，0:closed，1:opened。",
			},
			"cc_protection": {
				Required:     true,
				Type:         schema.TypeInt,
				ValidateFunc: tccommon.ValidateAllowedIntValue([]int{0, 1}),
				Description:  "CC 模块 状态，0:closed，1:opened。",
			},
			"api_protection": {
				Required:     true,
				Type:         schema.TypeInt,
			...
			"anti_tamper": {
				...
				Type:         schema.TypeInt,
				ValidateFunc: tccommon.ValidateAllowedIntValue([]int{0, 1}),
				Description:  "Anti tamper 模块 状态，0:closed，1:opened。",
			},
			"anti_leakage": {
				Optional:     true,
				Type:         schema.TypeInt,
				ValidateFunc: tccommon.ValidateAllowedIntValue([]int{0, 1}),
				Description:  "Anti leakage 模块 状态，0:closed，1:opened。",
			},
		},
	}
}
