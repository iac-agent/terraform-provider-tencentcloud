	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"domain": {
				Required:    true,
				Type:        schema.TypeString,
				Description: "域名 names that require defense。",
			},
			"cert_type": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "Certificate 类型，0 represents no certificate，CertType=1 represents self owned certificate，and 2 represents managed certificate。",
			},
			"cert": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "Certificate 内容，When CertType=1，this parameter needs to be filled。",
			},
			"private_key": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "Certificate 键，When CertType=1，this parameter needs to be filled。",
			},
			"ssl_id": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "证书 ID，When CertType=2，this parameter needs to be filled。",
			},
			"is_cdn": {
				Type:         schema.TypeInt,
				Optional:     true,
			...
			"https_upstream_port": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "Upstream 端口 for https，When listen ports has https 端口 and UpstreamScheme is HTTP，the current field needs to be filled。",
			},
			"upstream_type": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "Upstream 类型，0 represents IP，1 represents 域名 名称",
			},
			"upstream_domain": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "Upstream 域名，When UpstreamType=1，this parameter needs to be filled。",
			},
			"src_list": {
				Optional:    true,
			...
			"is_http2": {
				...
				Description:  "Whether enable HTTP2，Enabling HTTP2 requires HTTPS support，1 means 已启用，0 does not。",
			},
			"is_websocket": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "Is WebSocket support 已启用 1 means 已启用，0 does not。",
			},
			"load_balance": {
				Optional:     true,
				Type:         schema.TypeString,
			...
			"is_keep_alive": {
				...
				Description:  "是否enable keep-alive，0 disable，1 enable。",
			},
			"weights": {
				Optional:    true,
				Type:        schema.TypeList,
				Elem:        &schema.Schema{Type: schema.TypeInt},
				Description: "权重 of each upstream。",
			},
			"active_check": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "是否enable 活跃 health detection，0 represents disable and 1 represents enable。",
			},
			"tls_version": {
				Optional:    true,
				Type:        schema.TypeInt,
				Default:     TLS_VERSION_STATUS_3,
				Description: "版本 of TLS 协议",
			},
			"ciphers": {
				Optional:    true,
				Computed:    true,
			...
			"sni_type": {
				...
				Description:  "Sni 类型 fo upstream，0:disable SNI; 1:enable SNI and SNI equal original request 主机; 2:and SNI equal upstream 主机 3:enable SNI and equal customize 主机",
			},
			"sni_host": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "When SniType=3，this parameter needs to be filled in to represent a custom 主机",
			},
			"ip_headers": {
				Optional:    true,
				Type:        schema.TypeList,
			...
			"status": {
				...
				Description:  "WAF switch 状态，1: turn on WAF switch; 0: turn off WAF switch。",
			},
			"domain_id": {
				Type:        schema.TypeString,
				Computed:    true,
