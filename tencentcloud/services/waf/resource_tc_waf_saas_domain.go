	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"domain": {
				Required:    true,
				Type:        schema.TypeString,
				Description: "域名 names 该 require defense。",
			},
			"cert_type": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "Certificate 类型，0 表示 无 证书，CertType=1 表示 self owned 证书，和 2 表示 managed 证书。",
			},
			"cert": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "Certificate 内容，当 CertType=1，此 参数 needs 到 是 filled。",
			},
			"private_key": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "Certificate 键，当 CertType=1，此 参数 needs 到 是 filled。",
			},
			"ssl_id": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "证书 ID，当 CertType=2，此 参数 needs 到 是 filled。",
			},
			"is_cdn": {
				Type:         schema.TypeInt,
				Optional:     true,
			...
			"upstream_scheme": {
				...
				Description:  "Upstream scheme 对于 https，http 或 https。",
			},
			"https_upstream_port": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "Upstream 端口 对于 https，当 listen ports has https 端口 和 UpstreamScheme 是 HTTP， 当前 字段 needs 到 是 filled。",
			},
			"upstream_type": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "Upstream 类型，0 表示 IP，1 表示 域名 名称",
			},
			"upstream_domain": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "Upstream 域名，当 UpstreamType=1，此 参数 needs 到 是 filled。",
			},
			"src_list": {
				Optional:    true,
				Type:        schema.TypeList,
				Elem:        &schema.Schema{Type: schema.TypeString},
				Description: "Upstream IP List，当 UpstreamType=0，此 参数 needs 到 是 filled。",
			},
			"is_http2": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "Whether 启用 HTTP2，Enabling HTTP2 requires HTTPS support，1 表示 已启用，0 does 不。",
			},
			"is_websocket": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "Is WebSocket support 已启用 1 表示 已启用，0 does 不。",
			},
			"load_balance": {
				Optional:     true,
				Type:         schema.TypeString,
				...
				Description:  "Load balancing strategy，其中 0 表示 polling 和 1 表示 IP hash 和 2 weighted round robin。",
			},
			"https_rewrite": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "Whether redirect 到 https，1 将 redirect 和 0 将 不。",
			},
			"ports": {
				Required:    true,
				Type:        schema.TypeSet,
				Description: "此 字段 needs 到 是 集合 对于 多个 ports 在 upstream 服务器。",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"port": {
							Type:        schema.TypeString,
							Required:    true,
							Description: "Listening 端口",
						},
						"protocol": {
							Type:        schema.TypeString,
							Required:    true,
			...
			"is_keep_alive": {
				...
				Description:  "是否enable keep-alive，0 disable，1 启用。",
			},
			"weights": {
				Optional:    true,
				Type:        schema.TypeList,
				Elem:        &schema.Schema{Type: schema.TypeInt},
				Description: "权重 的 each upstream。",
			},
			"active_check": {
				Optional:     true,
				Type:         schema.TypeInt,
				...
				Description:  "是否enable 活跃 health detection，0 表示 disable 和 1 表示 启用。",
			},
			"tls_version": {
				Optional:    true,
				Type:        schema.TypeInt,
				Default:     TLS_VERSION_STATUS_3,
				Description: "版本 的 TLS 协议",
			},
			"ciphers": {
				Optional:    true,
				Computed:    true,
			...
			"cipher_template": {
				...
				Description:  "Encryption Suite 模板，0:默认值 1:Universal template 2:Security template 3:Custom template。",
			},
			"proxy_read_timeout": {
				Optional:    true,
				Type:        schema.TypeInt,
			...
			"sni_type": {
				...
				Description:  "Sni 类型 fo upstream，0:disable SNI; 1:启用 SNI 和 SNI equal original 请求 主机; 2:和 SNI equal upstream 主机 3:启用 SNI 和 equal customize 主机",
			},
			"sni_host": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "当 SniType=3，此 参数 needs 到 是 filled 在 到 represent 自定义 主机",
			},
			"ip_headers": {
				Optional:    true,
				Type:        schema.TypeList,
			...
			"xff_reset": {
				...
				Description:  "0:disable xff reset; 1:启用 xff reset。",
			},
			"bot_status": {
				Type:         schema.TypeInt,
				Optional:     true,
			...
			"status": {
				...
				Description:  "WAF switch 状态，1: turn 在 WAF switch; 0: turn 关闭 WAF switch。",
			},
			"domain_id": {
				Type:        schema.TypeString,
				Computed:    true,
