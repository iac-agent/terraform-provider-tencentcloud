	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"attack_threshold": {
				...
				Description:  "阈值 数量 attacks 该 triggers IP autodeny，ranging 从 2 到 100 times。",
			},
			"time_threshold": {
				Required:     true,
				ForceNew:     true,
				...
				Description:  "IP autodeny statistical 时间，ranging 从 1-60 minutes。",
			},
			"deny_time_threshold": {
				Required:     true,
				ForceNew:     true,
				...
				Description:  "IP autodeny 时间 after triggering IP autodeny，ranging 从 5 到 360 minutes。",
			},
		},
	}
}
