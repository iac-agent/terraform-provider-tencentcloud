				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"mode": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "Rule defense 模式，0 observation 模式，1 interception 模式",
						},
						"engine": {
							Type:        schema.TypeInt,
							Computed:    true,
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									...
									"listener_name": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Listener name注意：此字段可能返回 null，表示无法获取有效值。",
									},
									"load_balancer_id": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "LoadBalancer ID注意：此字段可能返回 null，表示无法获取有效值。",
									},
									"load_balancer_name": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "LoadBalancer name注意：此字段可能返回 null，表示无法获取有效值。",
									},
									"protocol": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Listener protocol注意：此字段可能返回 null，表示无法获取有效值。",
									},
									"region": {
										Type:        schema.TypeString,
										Computed:    true,
									...
									"vip": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "LoadBalancer ip注意：此字段可能返回 null，表示无法获取有效值。",
									},
									"vport": {
										Type:        schema.TypeInt,
										Computed:    true,
										Description: "Listener port注意：此字段可能返回 null，表示无法获取有效值。",
									},
									"zone": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Loadbalancer zone注意：此字段可能返回 null，表示无法获取有效值。",
									},
									"numerical_vpc_id": {
										Type:        schema.TypeInt,
										Computed:    true,
									...
									"load_balancer_type": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Loadbalancer type注意：此字段可能返回 null，表示无法获取有效值。",
									},
								},
							},
						},
						...
						"cdc_clusters": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Cdc clusters注意：此字段可能返回 null，表示无法获取有效值。",
						},
						"api_status": {
							Type:        schema.TypeInt,
							Computed:    true,
...
func dataSourceTencentCloudWafDomainsRead(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("data_source.tencentcloud_waf_domains.read")()
