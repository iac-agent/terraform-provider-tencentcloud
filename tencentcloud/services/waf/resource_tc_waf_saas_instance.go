	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"goods_category": {
				...
				Description:  "Billing 顺序 参数. support premium_saas，enterprise_saas，ultimate_saas。",
			},
			"time_span": {
				Optional:     true,
				Type:         schema.TypeInt,
			...
			"real_region": {
				...
				Description:  "地域 如果 地域 是 `ap-guangzhou`，support: gz，sh，bj，cd (Means: GuangZhou，ShangHai，BeiJing，ChengDu); 如果 地域 是 `ap-seoul`，support: hk，sg，th，kr，在，de，ca，使用，sao，usw，jkt (Means: HongKong，Singapore，Bandkok，Seoul，Mumbai，Frankfurt，Toronto，Virginia，SaoPaulo，SiliconValley，Jakarta)。",
			},
			"bot_management": {
				Optional:     true,
				Type:         schema.TypeInt,
