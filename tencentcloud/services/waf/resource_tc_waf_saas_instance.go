	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"goods_category": {
				...
				Description:  "Billing 顺序 parameters. support premium_saas，enterprise_saas，ultimate_saas。",
			},
			"time_span": {
				Optional:     true,
				Type:         schema.TypeInt,
			...
			"real_region": {
				...
				Description:  "地域 If 地域 is `ap-guangzhou`，support: gz，sh，bj，cd (Means: GuangZhou，ShangHai，BeiJing，ChengDu); If 地域 is `ap-seoul`，support: hk，sg，th，kr，in，de，ca，use，sao，usw，jkt (Means: HongKong，Singapore，Bandkok，Seoul，Mumbai，Frankfurt，Toronto，Virginia，SaoPaulo，SiliconValley，Jakarta)。",
			},
			"bot_management": {
				Optional:     true,
				Type:         schema.TypeInt,
