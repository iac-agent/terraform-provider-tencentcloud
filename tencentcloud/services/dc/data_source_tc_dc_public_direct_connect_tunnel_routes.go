	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"filters": {
				...
				Description: "过滤器 condition: 路由-类型: 路由 类型，值: BGP/STATIC 路由-子网: 路由 cidr，值 such 作为: 192.68.1.0/24。",
			...
			"routes": {
				Computed:    true,
				Type:        schema.TypeList,
				Description: "Internet tunnel 路由 列表。",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"route_id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "direct connect tunnel 路由 ID。",
						},
						...
						"route_type": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "Route 类型: BGP/STATIC 路由。",
						},
						"status": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "ENABLE: routing 是 已启用，DISABLE: routing 是 已禁用",
						},
						"as_path": {
							Type: schema.TypeSet,
							Elem: &schema.Schema{
