	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"protocol": {
				Type:        schema.TypeString,
				Required:    true,
				Description: "协议 If Direction=1，可选 values: TCP，UDP，ANY; If Direction=0，可选 values: TCP，UDP，ICMP，ANY，HTTP，HTTPS，HTTP/HTTPS，SMTP，SMTPS，SMTP/SMTPS，FTP，and DNS。",
			},
			"rule_action": {
				Type:         schema.TypeString,
				Required:     true,
			...
			"scope": {
				...
				Optional:    true,
				Computed:    true,
				Description: "范围 of effective rules. ALL: Global effectiveness; ap-guangzhou: Effective territory; cfwnat-xxx: Effectiveness based on instance dimension。",
			},
			// computed
			"uuid": {
				Type:        schema.TypeInt,
