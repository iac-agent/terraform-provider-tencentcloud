	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"inbound_rule_uuid_list": {
				...
				Optional:    true,
				Computed:    true,
				Description: "The unique IDs of the inbound rule，which 不是必填项 when you create a rule. The 优先级 will be determined by the 索引 position of the UUID in the list。",
			...
			"outbound_rule_uuid_list": {
				...
				Optional:    true,
				Computed:    true,
				Description: "The unique IDs of the outbound rule，which 不是必填项 when you create a rule. The 优先级 will be determined by the 索引 position of the UUID in the list。",
				Elem:        &schema.Schema{Type: schema.TypeInt},
			},
		},
	}
