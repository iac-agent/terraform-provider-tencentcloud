	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"type": {
				...
				Required:     true,
				ForceNew:     true,
				ValidateFunc: tccommon.ValidateAllowedStringValue([]string{lbNetworkTypeOpen, lbNetworkTypeInternal}),
				Description: "LB的网络类型。有效值：“打开”、“内部”。",
			},
			"forward": {
				Type:         schema.TypeString,
				Optional:     true,
				ForceNew:     true,
				Computed:     true,
				ValidateFunc: tccommon.ValidateAllowedStringValue([]string{lbForwardTypeClassic, lbForwardTypeApplication}),
				Description: "LB 的类型。有效值：“经典”、“应用程序”。",
			},
			"name": {
				Type:        schema.TypeString,
				Optional:    true,
			...
			"vpc_id": {
				...
				ForceNew:    true,
				Computed:    true,
				Description: "LB的VPC ID，未指定或0代表CVM基础网络。",
			},
			"project_id": {
				Type:        schema.TypeInt,
				Optional:    true,
				ForceNew:    true,
				Computed:    true,
				Description: "LB的项目id，未指定或0代表默认项目。",
			},
			"status": {
				Type:        schema.TypeString,
				Computed:    true,
...
func resourceTencentCloudLBCreate(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_clb.create")()
...
func resourceTencentCloudLBRead(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_clb.read")()
...
func resourceTencentCloudLBUpdate(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_clb.update")()
...
func resourceTencentCloudLBDelete(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_clb.delete")()
